...
#                script (type 'simulation_Perceptron.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.simulation_Perceptron xil_defaultlib.glbl -o simulation_Perceptron_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./simulation_Perceptron_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lespiaucq/5SEE/Implementation"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key simulation_Perceptron_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc simulation_Perceptron_simv.daidir vcs_lib c.obj)
