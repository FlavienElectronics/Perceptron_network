...
#
# Script generated by Vivado on Thu Jan 15 11:22:44 CET 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : simulation_Perceptron.sh
...
#
# Usage        : simulation_Perceptron.sh
#                simulation_Perceptron.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                simulation_Perceptron.sh [-reset_run]
#                simulation_Perceptron.sh [-reset_log]
#                simulation_Perceptron.sh [-help]
#
...
# script info
echo -e "simulation_Perceptron.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./simulation_Perceptron.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot simulation_Perceptron xil_defaultlib.simulation_Perceptron xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim simulation_Perceptron -key {Behavioral:sim_1:Functional:simulation_Perceptron} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb simulation_Perceptron.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./simulation_Perceptron.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: simulation_Perceptron.sh [-help]\n\
Usage: simulation_Perceptron.sh [-step]\n\
Usage: simulation_Perceptron.sh [-lib_map_path]\n\
Usage: simulation_Perceptron.sh [-reset_run]\n\
Usage: simulation_Perceptron.sh [-reset_log]\n\
Usage: simulation_Perceptron.sh [-keep_index]\n\
Usage: simulation_Perceptron.sh [-noclean_files]\n\n\
